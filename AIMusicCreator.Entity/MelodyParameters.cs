...
namespace AIMusicCreator.Entity
{
    ...
    public partial class MelodyParameters
    {
        /// <summary>
        /// 存储用户自定义的小节数量
        /// </summary>
        ...
        /// <summary>
        /// 伴奏模式（arpeggio, block, rhythmic）
        /// </summary>
        public string AccompanimentPattern { get; set; } = "block";
        ...
        /// 是否生成打击乐声部
        /// </summary>
        public bool IncludePercussion { get; set; } = true;

        /// <summary>
        /// 伴奏密度（0.0-1.0）
        /// </summary>
        public double Density { get; set; } = 0.7;
        /// <summary>
        /// 默认构造函数
        /// </summary>
        /// <remarks>
        ...
        public MelodyParameters(MusicStyle style, Emotion emotion, int bpm,
    ...
    //    ///// 音阶类型
    //    ///// </summary>
    //    //public Scale? Scale { get; set; } = Models.Scale.Major;
